 ...
 * 
 * @Value("${service.url}") private String serviceUrl;
 * 
 * List<StudentResponse> studentsList; int index = 0;
 * 
 ...
 * 
 * if(studentsList == null) { restCallToGetStudents(); }
 * 
 * if(studentsList != null && !studentsList.isEmpty() && index <
 * studentsList.size()) { StudentResponse stu = studentsList.get(index);
 * index++; return stu; }
 * 
 * return null;
 * 
